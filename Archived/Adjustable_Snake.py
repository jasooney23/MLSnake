...
class game:
    ...
    def start(self, agent):
        ...
        while self.running:
            # Calls on the agent to make a decision as to which action to use for the next frame.
            agent.step()

            # After the agent makes that decision, make the agent learn.
            agent.learn()
