...
class agent:
    ...
    def save_all(self):
        ...
        mem.save_memory(self.states_memory, self.action_memory, self.reward_memory, self.transitions_memory)
    ...
    def epsilon_action(self):
        ...
        current_epsilon = cfg.start_epsilon - ((cfg.start_epsilon - cfg.end_epsilon) * explore_count_percent)
    ...
    def step(self):
        ...
        if len(self.phi) > cfg.stack_size:
            ...
            self.update_memory(phi_last, cfg.directions.index(action), state_reward[1], phi_current)
    ...
    def get_batch_indices(self):
        ...
        for _ in range(cfg.batch_size):
            indices.append(random.randint(0, self.train_data["filled_memory"] - 1))
